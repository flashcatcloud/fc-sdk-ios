...
public enum objc_VitalsFrequency: Int {
    ...
    internal init(swiftType: FlashcatRUM.RUM.Configuration.VitalsFrequency?) {
        switch swiftType {
    ...
    internal var swiftType: FlashcatRUM.RUM.Configuration.VitalsFrequency? {
        switch self {
...
public class objc_RUMConfiguration: NSObject {
    internal var swiftConfig: FlashcatRUM.RUM.Configuration
...
public class objc_RUMMonitor: NSObject {
    ...
    internal let swiftRUMMonitor: FlashcatRUM.RUMMonitorProtocol

    internal init(swiftRUMMonitor: FlashcatRUM.RUMMonitorProtocol) {
