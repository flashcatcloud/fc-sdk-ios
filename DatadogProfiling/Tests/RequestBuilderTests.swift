...
class RequestBuilderTests: XCTestCase {
    ...
    func testItSetsIntakeURL() {
        ...
        // When
        func url(for site: FlashcatSite) throws -> String {
        ...
        // Then
        XCTAssertEqual(try url(for: .cn), "https://browser.flashcat.cloud/api/v2/profile")
        XCTAssertEqual(try url(for: .staging), "https://jira.flashcat.cloud/api/v2/profile")
    }
    ...
    func testItSetsCustomIntakeURL() {
        ...
        XCTAssertEqual(try url(for: .cn), expectedURL)
