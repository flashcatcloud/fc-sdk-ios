...
public final class CoreRegistry {
    ...
    public static var `default`: FlashcatCoreProtocol {
    ...
    @ReadWriteLock
    internal private(set) static var instances: [String: FlashcatCoreProtocol] = [:]
    ...
    public static func register(default instance: FlashcatCoreProtocol) {
    ...
    public static func register(_ instance: FlashcatCoreProtocol, named name: String) {
    ...
    @discardableResult
    public static func unregisterInstance(named name: String) -> FlashcatCoreProtocol? {
    ...
    /// - Returns: The instance that was removed, or nil if the key was not present in the registry.
    @discardableResult
    public static func unregisterDefault() -> FlashcatCoreProtocol? {
    ...
    public static func instance(named name: String) -> FlashcatCoreProtocol {
    ...
    public static func isFeatureEnabled<T>(feature: T.Type) -> Bool where T: FlashcatFeature {
