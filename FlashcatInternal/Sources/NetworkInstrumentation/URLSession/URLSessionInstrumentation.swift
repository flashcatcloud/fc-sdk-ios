...
public enum URLSessionInstrumentation {
    ...
    public static func enable(with configuration: URLSessionInstrumentation.Configuration, in core: FlashcatCoreProtocol = CoreRegistry.default) {
        do {
    ...
    internal static func enableOrThrow(with configuration: URLSessionInstrumentation.Configuration, in core: FlashcatCoreProtocol) throws {
    ...
    public static func disable(delegateClass: URLSessionDataDelegate.Type, in core: FlashcatCoreProtocol = CoreRegistry.default) {
        do {
    ...
    internal static func disableOrThrow(delegateClass: URLSessionDataDelegate.Type, in core: FlashcatCoreProtocol) throws {
        guard let feature = core.get(feature: NetworkInstrumentationFeature.self) else {
            throw ProgrammerError(description: "URLSession tracking must be enabled before enabling URLSessionInstrumentation using either RUM or Trace feature.")
        }
