...
extension Double: FlashcatExtended {}
extension FlashcatExtension where ExtendedType == Double {
...
// MARK: - UUID
extension UUID: FlashcatExtended {}
extension FlashcatExtension where ExtendedType == UUID {
...
// MARK: - Collection
extension FlashcatExtension where ExtendedType: Collection {
...
// MARK: - Bundle
extension Bundle: FlashcatExtended {}
extension FlashcatExtension where ExtendedType == Bundle {
