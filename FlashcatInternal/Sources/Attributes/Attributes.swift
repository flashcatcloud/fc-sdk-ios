...
extension FlashcatExtension where ExtendedType == [String: Any] {
    public var swiftAttributes: [String: Encodable] {
        type.mapValues { AnyEncodable($0) }
    }
}

extension FlashcatExtension where ExtendedType == [String: Encodable] {
...
extension FlashcatExtension where ExtendedType == AttributeValue {
